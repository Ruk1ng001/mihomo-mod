...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/Ruk1ng001/mihomo-mod/constant.Version=$(VERSION)" \
		-X "github.com/Ruk1ng001/mihomo-mod/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
